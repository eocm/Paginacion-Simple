...
void Proyecto::Inicio()
{
    ...
    cout << "Escriba el numero de procesos a realizar: " << endl;
    cin >> NumProcesos;

    cout << "Escriba el valor del Quantum: " << endl;
    cin >> quantum;
    ...
    do
    {
        ...
        if(bandOperacion == true){
            tme = DESDE + rand()%(HASTA+1-DESDE); // Tiempo de ejecucion del proceso (TME) entre 6 y 16
            if(tme <= 0){
                bandTME = false;
            }
...
void Proyecto::NuevoProceso()
{
    ...
    do
    {
        ...
        tamanio = DESDE_T + rand()%(HASTA_T+1-DESDE_T); // Tamaño de la operación en bytes (5-25)
        cos = tamanio/5; // Costo de la operación en ciclos de CPU (1 ciclo por cada 5 bytes)
        res = tamanio%5; // Residuo de la operación en ciclos de CPU (1 ciclo por cada 5 bytes)
...
void Proyecto::MostrarTabla() // Informacion tabla BCP
{
    int id, idAux;
    ...
    while(bandFinal!=false){
        ...
        estado = p.getEstado();
        TRB = 6 - p.getTTB(); // Tiempo restante de bloqueo (6 - Tiempo de bloqueo)
        error = p.getResultadoError();
        resultado = p.getResultado();
        operacion = p.getOperacion();
        tme = p.getTME();
...
void Proyecto::TablaPaginas()//////////////////////////////////////////////////////////////////////TABLA de PAGINAS
{
    ...
    if(primeraLLam == 0){
        ...
        for(m; m < 44; m++){// 44 es el numero de marcos
            if(m > 39){ // 40 es el numero de marcos que se pueden usar /////////////////////////////////////////////////////////////////////////////////////////////////
                nada.setMarco(m);
                nada.setMB("0/5"); // 0/5 es el numero de marcos que se pueden usar 
                nada.setID(50); 
